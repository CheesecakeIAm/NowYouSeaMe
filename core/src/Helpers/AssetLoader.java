...
public class AssetLoader {
    ...
    public static void load() {
        Diver = new Texture(Gdx.files.internal("assets/Diver.png"));
        DiverSprite = new Sprite(Diver);
        DiverSprite.flip(false,true);

        BG = new Texture(Gdx.files.internal("assets/background.png"));
        BGSprite = new Sprite(BG);
        BGSprite.flip(false, true);
        BGSpriteFlipped = new Sprite(BG);
        BGSpriteFlipped.flip(true, true);
        
        Cave = new Texture(Gdx.files.internal("assets/underwatercave.png"));
        CaveSprite = new Sprite(Cave);
        CaveSprite.flip(false, true);
        
        Opaque1 = new Texture(Gdx.files.internal("assets/Opaque.png"));
        OpaqueSprite1 = new Sprite(Opaque1);
        Gradiant = new Texture(Gdx.files.internal("assets/gradiant.png"));
        gradiantSprite = new Sprite(Gradiant);
        gradiantSprite.flip(false, false);
        
        Mine = new Texture(Gdx.files.internal("assets/mine.png"));
        MineSprite = new Sprite(Mine);
        MineSprite.flip(false,true);
        
        Ship = new Texture(Gdx.files.internal("assets/sunkenship.png"));
        ShipSprite = new Sprite(Ship);
        ShipSprite.flip(false,true);
        
        fish1 = new Texture(Gdx.files.internal("assets/fish1.png"));
        fish1Sprite = new Sprite(fish1);
        fish1Sprite.flip(false, true);
        
        fish2 = new Texture(Gdx.files.internal("assets/fish2.png"));
        fish2Sprite = new Sprite(fish2);
        fish2Sprite.flip(false, true);
        
        fish3 = new Texture(Gdx.files.internal("assets/fish3.png"));
        fish3Sprite = new Sprite(fish3);
        fish3Sprite.flip(false, true);
        
        fish4 = new Texture(Gdx.files.internal("assets/fish4.png"));
        fish4Sprite = new Sprite(fish4);
        fish4Sprite.flip(false, true);
        
        fish5 = new Texture(Gdx.files.internal("assets/fish5.png"));
        fish5Sprite = new Sprite(fish5);
        fish5Sprite.flip(false, true);
        
        fish6 = new Texture(Gdx.files.internal("assets/fish6.png"));
        fish6Sprite = new Sprite(fish6);
        fish6Sprite.flip(false, true);
        
        fish7 = new Texture(Gdx.files.internal("assets/fish7.png"));
        fish7Sprite = new Sprite(fish7);
        fish7Sprite.flip(false, true);
        
        fish8 = new Texture(Gdx.files.internal("assets/fish8.png"));
        fish8Sprite = new Sprite(fish8);
        fish8Sprite.flip(false, true);
        
        fish9 = new Texture(Gdx.files.internal("assets/fish9.png"));
        fish9Sprite = new Sprite(fish9);
        fish9Sprite.flip(false, true);
        
        fish10 = new Texture(Gdx.files.internal("assets/fish10.png"));
        fish10Sprite = new Sprite(fish10);
        fish10Sprite.flip(false, true);
        
        fish11 = new Texture(Gdx.files.internal("assets/fish11.png"));
        ...
        volumeButton = new Texture(Gdx.files.internal("assets/volumebutton2.png"));
        volumeSprite = new Sprite(volumeButton);
        volumeSprite.flip(false, true);
        
        muteButton = new Texture(Gdx.files.internal("assets/mutebutton2.png"));
        muteSprite = new Sprite(muteButton);
        muteSprite.flip(false, true);
     
        font = new BitmapFont(Gdx.files.internal("assets/font.fnt"), true);
        
        song = Gdx.audio.newSound(Gdx.files.internal("assets/underwater2.mp3"));
